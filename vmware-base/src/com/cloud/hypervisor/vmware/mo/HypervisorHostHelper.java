...
public class HypervisorHostHelper {
    ...
    public static Pair<ManagedObjectReference, String> prepareNetwork(String vSwitchName, String namePrefix,
        ...
        // TODO(sateesh): Remove this after ensuring proper default value for vSwitchName throughout traffic types and
        // switch types.
        if (vSwitchName == null) {
            s_logger.warn("Detected null vSwitch. Defaulting to vSwitch0");
