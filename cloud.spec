...
#
rm -f $RPM_BUILD_ROOT/usr/share/java/XmlSchema-1.4.2.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/activation-1.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/annogen-0.1.0.jar
...
rm -f $RPM_BUILD_ROOT/usr/share/java/axis-jaxrpc-1.4.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/axis2-1.5.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/axis2-adb-1.4.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/axis2-adb-codegen-1.4.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/axis2-ant-plugin-1.4.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/axis2-codegen-1.4.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/axis2-java2wsdl-1.4.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/axis2-kernel-1.4.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/cglib-nodep-2.2.2.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/cloud-agent-4.0.0-SNAPSHOT-tests.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/cloud-com.thoughtworks.selenium-1.0.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/cloud-console-proxy-4.0.0-SNAPSHOT.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/cloud-iControl.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/cloud-manageontap.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/cloud-netscaler-sdx.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/cloud-netscaler.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/cloud-patches-4.0.0-SNAPSHOT.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/cloud-utils-4.0.0-SNAPSHOT-tests.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/commons-collections-3.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/commons-collections-3.2.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/commons-fileupload-1.2.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/commons-io-1.4.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/commons-logging-1.0.4.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/commons-logging-1.1.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/dom4j-1.6.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/geronimo-activation_1.1_spec-1.0.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/geronimo-javamail_1.4_spec-1.2.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/geronimo-jms_1.1_spec-1.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/geronimo-stax-api_1.0_spec-1.0.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/hamcrest-core-1.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/hibernate-annotations-3.5.1-Final.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/hibernate-commons-annotations-3.2.0.Final.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/hibernate-core-3.5.1-Final.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/hibernate-entitymanager-3.5.1-Final.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/httpcore-nio-4.0-beta1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/icontrol-1.0.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/javassist-3.9.0.GA.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/jaxen-1.1.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/json-simple-1.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/jsr107cache-1.0.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/jta-1.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/manageontap-1.0.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/mysql-connector-java-5.1.21.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/neethi-2.0.4.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/netscaler-1.0.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/netscaler-sdx-1.0.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/selenium-server-1.0.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/servlet-api-2.3.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/servlet-api-2.5-20081211.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/slf4j-api-1.5.8.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/stax-api-1.0.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/woden-api-1.0M8.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/woden-impl-dom-1.0M8.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/ws-commons-util-1.0.2.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/wstx-asl-3.2.4.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/xalan-2.7.0.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/xercesImpl-2.6.2.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/xercesImpl-2.8.1.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/xml-apis-1.0.b2.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/xml-apis-1.3.04.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/xmlParserAPIs-2.6.0.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/xpp3_min-1.1.4c.jar
rm -f $RPM_BUILD_ROOT/usr/share/java/xstream-1.3.1.jar
